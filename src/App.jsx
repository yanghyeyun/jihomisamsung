...
function App() {
  ...
  const [coin, setcoin] = useState(((maxPrice/askPrice) - (maxPrice/askPrice*0.0005)).toFixed(6)); 
  const [pPrice, setpPrice] = useState(((coin*bidPrice)-(coin*bidPrice*0.0005)+1).toFixed(0)); 
