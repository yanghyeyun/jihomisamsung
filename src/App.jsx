...
function App() {
  ...
  const [purchases, setpurchases] = useState(((maxPrice/askPrice) - (maxPrice/askPrice*0.0005)).toFixed(6)); 
  const [pPrice, setpPrice] = useState(((purchases*bidPrice)-(purchases*bidPrice*0.0005)+1).toFixed(0)); 
